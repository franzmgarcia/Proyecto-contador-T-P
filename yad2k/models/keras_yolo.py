...
def yolo_head(feats, anchors, num_classes):
    ...
    """
    # Lememos el numero de box anchors
    num_anchors = len(anchors)

    #hacemos reshape del batch, altura, ancho, numero de anchors y parametros

    anchors_tensor = K.reshape(K.variable(anchors), [1, 1, 1, num_anchors, 2])

    # Implementacion dinamica para conv dims en el modelo convolucional
    conv_dims = K.shape(feats)[1:3]
    # En el modelo YOLO el height index es la iteracion mas interna
